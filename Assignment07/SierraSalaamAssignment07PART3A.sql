...
-- Insert New Trigger
CREATE OR REPLACE TRIGGER CorrectCourseNr
...
BEGIN
    :new.CourseNr := 597;
    DBMS_OUTPUT.PUT_Line('The number is to high, we will insert 597 as the new value');
    END;
/
SET SERVEROUTPUT ON;
...
insert into course
    values ( 0718, 'Sierra Birthday 1993', 'DC', 718); --test value
